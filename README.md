...
- ++ ADD SMALL LABELS TO SCATTER PLOT FOR EACH SPLIT SECTION (LOW, MEDIUM, ETC.)

- ++ GET RID OF SAMPLE SIZE FOR SCATTERPLOT, MAKE IT WHOLE POPULATION

- ++ ABOVE BAR CHART, CUT THE DECIMAL TO 4 DECIMAL PLACES

- ++ MAKE README PRETTIER

- ++ GET GPL OR MIT LICENSE - OPEN SOURCE SOFTWARE LICENSE
